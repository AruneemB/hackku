...
1. **Working Demo** *(live or recorded)*: Show a traveler using the Copilot across Planning, Approval, In-trip, and Post-trip.
2. **Traveler Journey Map** *(1 page)*: Visualizing Before / During / After and escalation points.
3. **Prompt Set**: 8–12 example traveler prompts showing situational responses.
4. **Architecture + Privacy Summary**: Data flow, guardrails, and key assumptions.
